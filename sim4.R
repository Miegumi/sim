...
result_holp = foreach(i=1:100, .combine = "rbind") %do% sim4(n,p,k,p1,r.square)$lag_holp ##rerun 100 times
result_sis = foreach(i=1:100, .combine = "rbind") %do% sim4(n,p,k,p1,r.square)$lag_sis
result_rrcs = foreach(i=1:100, .combine = "rbind") %do% sim4(n,p,k,p1,r.square)$lag_rrcs
result_isis = foreach(i=1:100, .combine = "rbind") %do% sim4(n,p,k,p1,r.square)$lag_isis
result_forward = foreach(i=1:100, .combine = "rbind") %do% sim4(n,p,k,p1,r.square)$lag_forward
